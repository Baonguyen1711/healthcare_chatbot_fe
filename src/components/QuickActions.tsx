        ...
        <div className="space-y-6">
            <div className="text-center">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                    Trợ lý chăm sóc sức khỏe thông minh với đầy đủ tính năng hỗ
                    trợ bạn quản lý sức khỏe hiệu quả
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {actions.map((action, index) => (
                    <Card
                        key={index}
                        className="group hover:shadow-medium transition-smooth border-0 bg-background/80 hover:scale-105 cursor-pointer"
                        onClick={() => handleActionClick(action.title)}
                    >
                        <CardContent className="p-6">
                            <div className="flex items-start gap-4">
                                <div
                                    className={`p-3 rounded-xl ${action.bg} group-hover:scale-110 transition-bounce`}
                                >
                                    <action.icon
                            ...
                            <Button
                                variant="ghost"
                                size="sm"
                                className="w-full mt-4 bg-primary/5 group-hover:bg-primary group-hover:text-primary-foreground transition-smooth"
                            >
                                Sử dụng ngay
                            </Button>
                        </CardContent>
