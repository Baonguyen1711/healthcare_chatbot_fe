...
const BillingTest = () => {
    ...
    const { bill, loading, error, refetch } = useLatestBill();
                ...
                <Card className="mb-6">
                    ...
                    <CardContent className="space-y-4">
                        <p className="text-sm text-muted-foreground">
                            API sẽ tự động lấy userId từ JWT token trong header Authorization.
                            Nhấn nút bên dưới để test.
                        </p>

                        <div className="flex gap-3">
                            <Button onClick={() => refetch()} disabled={loading} className="flex-1">
                                {loading ? (
                                    <>
